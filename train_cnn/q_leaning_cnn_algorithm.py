from display_cnn_results import *

class QLearningAlgorithmAgent():
    ...
    def vipe_options(self):
        self.num_actions = self.num_prim_actions
        self.idOption2Option = {}
        self.idOption2OptionTerminalState = {}
#         print("num actions")
#         print(self.num_actions)
        ...
        q_table_buf = np.zeros((8, 22, 4))
        q_table_buf[:, :, :] = self.q_table[:, :, :self.num_actions]
...
#         print(f"q_table shape is {self.q_table.shape}")
    ...
    def update_table(self, action_index, state):
        done=False
        reward_episode=0
        t = 0
...
#             print("")
            ...
            option.init_policy(trajectories)
    ...
    def choose_action(self, state):
        ...
        while (not done and self.t<1000):
            ...
            done, moves_made, state = self.update_table(action_index, state)
            #print(trajectory)
